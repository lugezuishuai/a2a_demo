...
export function buildAgentCard(config: AppConfig): AgentCard {
  return {
    ...
    description: 'A multi-provider LangGraph assistant exposed over A2A JSON-RPC.',
    ...
    skills: [
      {
        ...
        description: 'Answers text questions with the configured language model.',
        // 技能标签，用于能力检索、过滤和分类展示。
 ...
 */
export function createA2AServer(config: AppConfig, executor: AgentExecutor): A2AServerRuntime {
